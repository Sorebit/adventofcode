...
def test():
    ...
    tests = [
        ...
        {"in": [3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9], "info": "[MOD_POS] input was zero => 0, input is non-zero => 1"},
        {"in": [3,3,1105,-1,9,1101,0,0,12,4,12,99,1], "info": "[MOD_IMM] input was zero => 0, input is non-zero => 1"},
        {
