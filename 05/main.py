...
def test():
    ...
    tests = [
        ...
        {
            "in": [3, 9, 8, 9, 10, 9, 4, 9, 99, -1, 8],
            "out": [3, 9, 8, 9, 10, 9, 4, 9, 99, 1, 8],
            "info": "Position mode OP_EQ test\nInput 8 to pass",
        },
        {
            "in": [3, 9, 7, 9, 10, 9, 4, 9, 99, -1, 8],
            "out": [3, 9, 7, 9, 10, 9, 4, 9, 99, 1, 8],
            "info": "Position mode OP_LT test\nInput 7 or less to pass",
        },
        {
            "in": [3, 3, 1108, -1, 8, 3, 4, 3, 99],
            "out": [3, 3, 1108, 1, 8, 3, 4, 3, 99],
            "info": "Immediate mode OP_EQ test\nInput 8 to pass",
        },
        {
            "in": [3, 3, 1107, -1, 8, 3, 4, 3, 99],
            "out": [3, 3, 1107, 1, 8, 3, 4, 3, 99],
            "info": "Immediate mode OP_LT test\nInput 7 or less to pass",
        },
        {
            "in": [3, 12, 6, 12, 15, 1, 13, 14, 13, 4, 13, 99, -1, 0, 1, 9],
            "info": "[MOD_POS] input was zero => 0, input is non-zero => 1",
        },
        {
            "in": [3, 3, 1105, -1, 9, 1101, 0, 0, 12, 4, 12, 99, 1],
            "info": "[MOD_IMM] input was zero => 0, input is non-zero => 1",
        },
        {
            "in": [
                3,
